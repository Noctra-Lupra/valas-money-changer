...
export default function ReportIndex({
    ...
    date,
    reportData,
}: PageProps<{ date: string; reportData: ReportData }>) {
    const { saldo_awal, mutations, totals, ops } = reportData;
    ...
    const totalSaldoAkhir =
        ...
        saldoAkhirBca +
        saldoAkhirMandiri +
        (ops?.ghost_adjustment || 0);

    const grandTotalHariIni = totalSaldoAkhir + (totals.asset_valas || 0);

    const profitBersih = grandTotalHariIni - 0;
                    ...
                    <div className="flex w-full gap-3 md:w-auto">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button className="h-10 gap-2 bg-rose-600 px-4 text-white shadow-sm hover:bg-rose-700">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-blue-600 dark:text-blue-400">+{formatDisplayNumber(ops?.cash_in)}</span> */}
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex justify-between text-sm">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-orange-600 dark:text-orange-500">-{formatDisplayNumber(ops?.cash_out)}</span> */}
                                    </div>
                                </div>
                            </div>
                        ...
                        <CardContent className="space-y-5 pt-6">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-between rounded-lg border border-gray-100 bg-gray-50 p-2 dark:border-zinc-800 dark:bg-zinc-800/50">
                                    ...
                                    <span className="font-bold text-yellow-900 dark:text-white/80">
                        ...
                        <CardContent className="space-y-6 pt-6">
                            ...
                            <div className="space-y-3 rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-zinc-800 dark:bg-zinc-800/50">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span
                                        className={`font-bold ${(mutations.salesBca || 0) - (mutations.buyBca || 0) + (ops?.bca_in || 0) - (ops?.bca_out || 0) < 0 ? 'text-red-600' : 'text-white/80'}`}
                                    >
                                        {formatIDR(
                                            (mutations.salesBca || 0) -
                                                (mutations.buyBca || 0) +
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span
                                        className={`font-bold ${(mutations.salesMandiri || 0) - (mutations.buyMandiri || 0) + (ops?.mandiri_in || 0) - (ops?.mandiri_out || 0) < 0 ? 'text-red-600' : 'text-white/80'}`}
                                    >
                                        {formatIDR(
                                            (mutations.salesMandiri || 0) -
                                                (mutations.buyMandiri || 0) +

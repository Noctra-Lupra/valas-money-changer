...
class LaporanController extends Controller
{
    public function export(Request $request)
    {
        ...
        if ($dailyClosing) {
            ...
            $netProfit = $grandTotalHariIni - $yesterdayGrandTotal;
        ...
        $reportData['ops_out'] = $opsEntries->where('type', 'out')->values();
        $reportData['currencies'] = \App\Models\Currencies::all();
